...
class Cargo(models.Model):
    STATUS_CHOICES = [
        ('Kutilmoqda', 'Kutilmoqda'),  # Yangi status - foydalanuvchi topilmadi
        ('Omborda', 'Omborda'),
        ('Yo\'lda', 'Yo\'lda'),
        ('Punktda', 'Punktda'),
    ...
    # ✅ user maydoniga null=True qo'shildi
    user = models.ForeignKey(
        'accounts.User',
        on_delete=models.SET_NULL,  # SET_NULL - foydalanuvchi o'chirilsa null bo'ladi
        null=True,  # ✅ null bo'lishi mumkin
        blank=True,  # ✅ blank bo'lishi mumkin
        related_name='cargos',
